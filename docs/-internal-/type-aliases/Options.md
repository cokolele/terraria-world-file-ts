...
[terraria-world-file](../../globals.md) / [\<internal\>](../README.md) / Options
...
`T` *extends* [`Name`](../../terraria-world-file/namespaces/Section/type-aliases/Name.md)[] = [`Name`](../../terraria-world-file/namespaces/Section/type-aliases/Name.md)[]
