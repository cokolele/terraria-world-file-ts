...
[terraria-world-file](../README.md) / TileEntity

# Interface: TileEntity

Defined in: [src/sections/tileEntities.ts:4](https://github.com/cokolele/terraria-world-file-ts/blob/3c1037306d1e6b1cd8b92a0a27afc00d946c7c8b/src/sections/tileEntities.ts#L4)

## Extended by

- [`TrainingDummy`](TrainingDummy.md)
- [`ItemFrame`](ItemFrame.md)
- [`LogicSensor`](LogicSensor.md)
- [`DisplayDoll`](DisplayDoll.md)
- [`WeaponsRack`](WeaponsRack.md)
- [`HatRack`](HatRack.md)
- [`FoodPlatter`](FoodPlatter.md)
- [`Pylon`](Pylon.md)
